 ...
 <?php
        ...
        <form action="../../controller/controller.php">
            ...
            <section class="datos">
                ...
                <input type="text" name="fecha_ingreso" value="<?php echo $man->getIngreso(); ?>"  placeholder="dd/mm/aaaa" class="fecha2" required/></br>
                <div>Fecha de salida</div>
                <i class="ico_calendario far fa-calendar-alt" aria-hidden="true"></i>
                <input type="text" name="fecha_salida" value="<?php echo $man->getSalida(); ?>" placeholder="dd/mm/aaaa" class="fecha2" required/></br></br>
